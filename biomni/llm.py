...
def get_llm(
    ...
    if source == "OpenAI":
        ...
        # UNIFIED: All Ollama models use consistent settings for predictable results
        # No special temperature adjustments - let users control this for consistency
        print(f"🔧 Using Ollama model: {model} with temperature: {temperature}")
